...
def build_prob_model():
    ...
    epl = EPL(
        ...
        e1=ParamU("e1", EPL_TRUE["e1"], prior_type="gaussian", prior_settings=[EPL_TRUE["e1"], 0.1], limits=[-0.9, 0.9]),
        e2=ParamU("e2", EPL_TRUE["e2"], prior_type="gaussian", prior_settings=[EPL_TRUE["e2"], 0.1], limits=[-0.9, 0.9]),
        center_x=ParamU("center_x", EPL_TRUE["center_x"], prior_type="gaussian", prior_settings=[EPL_TRUE["center_x"], 0.05], limits=[-0.5, 0.5]),
        center_y=ParamU("center_y", EPL_TRUE["center_y"], prior_type="gaussian", prior_settings=[EPL_TRUE["center_y"], 0.05], limits=[-0.5, 0.5]),
    )
    shear = Shear(
