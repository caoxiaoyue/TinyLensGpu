...
from TinyLensGpu.PhysicalModel import PhysicalModel, EPL, Shear, GaussianEllipse
...
plt.suptitle(
    f"EPL+Shear+Gaussian source simulation  "
    f"(θ_E={EPL_TRUE['theta_E']}\", γ={EPL_TRUE['gamma']}, σ_src={SRC_TRUE['sigma']}\")",
    fontsize=11,
)
plt.tight_layout()
