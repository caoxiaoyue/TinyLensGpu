...
def build_model():
    """Build lens model with both lens light and source light."""
    ...
    # Set dynamic parameters for mass
    ...
    # Set dynamic parameters for source
    ...
    # Set dynamic parameters for lens light
