"""
Source-only model (Programmatic API).

This demo shows how to model a lensed source without position likelihood constraints.
"""
...
def build_model():
    """Build lens model with source light only."""
