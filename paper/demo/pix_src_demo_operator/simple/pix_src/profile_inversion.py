...
def profile_variant(label, output_path):
    ...
    with ck.ActiveContext(prob_model):
        ...
        # --- Stage 1: ray-tracing (same as matrix backend) ---
        def deflect_stage():
        ...
        # --- Stage 3: precompute operator data (weights + indices) ---
        def opdata_stage():
        ...
        # --- Stage 6: build A matvec data + rhs ---
        ...
        source_pixels, pcg_info = (
            solve_stage()  # call once for timing
        )
