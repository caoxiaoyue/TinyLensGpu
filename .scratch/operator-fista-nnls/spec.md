...
Define hard non-negative source reconstruction for the matrix-free operator pixelized-source backend using FISTA while preserving the existing approximate evidence structure.
